...
app.get("/signup", function (req, res) {
    ...
    let transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
            user: "medicinedonation2022@gmail.com",
            pass: "rgngucmrixrmxppg",
        },
    });
    ...
    const options = {
        from: "medicinedonation2022@gmail.com",
        to: req.query.txtEmail,
        subject: " Welcome to Medicine Donation",
        text: "Thanks for signing up,\nWhenever the art of Medicine is loved, there is also a love of humanity.So here, we welcome you to our Medicine donation Family.\n\nRegards\nUphar Garg",
    };
...
app.post("/donorprofile", function (req, res) {
    ...
    dbref.query("insert into dprofile value(?,?,?,?,?,?,?,?,?,?,?,?)", donordata, function (err) {
        if (err) {
            ...
            res.sendFile(process.cwd() + "/public/dash-donor.html");
        }
    })
})
...
app.get("/fetchAllneedyRecords",function(req,res){
    // console.log("donor k sare record dekhne aaya hu");
